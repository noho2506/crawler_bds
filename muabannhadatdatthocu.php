...
$html = file_get_html("http://www.muabannhadat.vn/dat-ban-dat-tho-cu-3532/tp-da-nang-s31?sf=dpo&so=d&p=65");
...
foreach ($tins as $t) {
	echo $title = $t->find("div.mbnd-item-body div.row div.col-lg-12 a h2.mbnd-item-title",0)->innertext;
